...
import (
	connectControllers "github.com/FloMorphic/morph-api/api/connect"
	...
	resourceControllers "github.com/FloMorphic/morph-api/api/resource"
...
func RegisterAll(app fiber.Router, store repository.Store) {
	...
	resourceControllers.Register(app)
	...
	connectControllers.Register(app, store)
